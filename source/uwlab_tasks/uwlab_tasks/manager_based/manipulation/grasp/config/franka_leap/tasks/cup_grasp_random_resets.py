...
from .pink_cup import GraspPinkCupFrankaLeapCfg, PINK_CUP_SPAWN_POS, PINK_CUP_TARGET_POS, PINK_CUP_OBJECT_NUM_POINTS
...
@configclass
class GraspPinkCupRandomResetsFrankaLeapJointAbsStateCollectCfg(GraspPinkCupRandomResetsFrankaLeapJointAbsStateCfg):
