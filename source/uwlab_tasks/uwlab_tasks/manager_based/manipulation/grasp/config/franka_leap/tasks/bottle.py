...
@configclass
class GraspBottleFrankaLeapJointAbs(GraspBottleFrankaLeap):
...
@configclass
class GraspBottleFrankaLeapIkRel(GraspBottleFrankaLeap):
...
@configclass
class GraspBottleFrankaLeapIkAbs(GraspBottleFrankaLeap):
