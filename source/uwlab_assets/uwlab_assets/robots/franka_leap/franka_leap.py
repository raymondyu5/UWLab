...
# Old version, with high gains for the arm
#IMPLICIT_FRANKA_LEAP.actuators = FRANKA_LEAP_ARM_ACTUATOR_CFG | FRANKA_LEAP_HAND_ACTUATOR_CFG

# Use real gains for the arm
IMPLICIT_FRANKA_LEAP.actuators = FRANKA_LEAP_REAL_GAINS_ARM_ACTUATOR_CFG | FRANKA_LEAP_HAND_ACTUATOR_CFG
