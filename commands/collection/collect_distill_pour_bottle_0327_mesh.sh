#!/bin/bash
#SBATCH --job-name=collect_distill_pour_0327_mesh
...
#SBATCH --output=logs/collect_distill_pour_0327_mesh_%j.out
#SBATCH --error=logs/collect_distill_pour_0327_mesh_%j.err
...
/gscratch/weirdlab/raymond/commands/uwlab/run_in_container.sh '
  ./uwlab.sh -p scripts/imitation_learning/collect_distill_trajectories.py \
    ...
    --horizon 112 \
    --num_episodes 2000 \
    --stored_seg_pc_source mesh \
    --output_dir logs/distill_collection/pour_bottle_0327_mesh \
    --headless
'
