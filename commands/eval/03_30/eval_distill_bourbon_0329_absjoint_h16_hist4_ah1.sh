...
#SBATCH --mem=128G
#SBATCH --time=4:00:00
#SBATCH --output=/mmfs1/gscratch/weirdlab/raymond/logs/uwlab_eval_distill_bourbon_0329_absjoint_h16_hist4_ah1_%j.out
#SBATCH --error=/mmfs1/gscratch/weirdlab/raymond/logs/uwlab_eval_distill_bourbon_0329_absjoint_h16_hist4_ah1_%j.err
...
/mmfs1/gscratch/weirdlab/raymond/commands/uwlab/run_in_container.sh '
  ./uwlab.sh -p scripts/eval/play_bc.py \
    ...
    num_envs=4 \
    record_video=true \
    output_dir=logs/eval/bottle_pour_bc_jointabs/distill_bourbon_0329_absjoint_h16_hist4_ah1
