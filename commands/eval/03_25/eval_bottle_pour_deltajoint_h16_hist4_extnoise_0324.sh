...
#SBATCH --mem=128G
#SBATCH --time=4:00:00
#SBATCH --output=/mmfs1/gscratch/weirdlab/raymond/logs/uwlab_eval_pour_extnoise_0324_%j.out
#SBATCH --error=/mmfs1/gscratch/weirdlab/raymond/logs/uwlab_eval_pour_extnoise_0324_%j.err
...
/mmfs1/gscratch/weirdlab/raymond/commands/uwlab/run_in_container.sh '
  ./uwlab.sh -p scripts/eval/play_bc.py \
    ...
    --sim_type distill \
    checkpoint=logs/bc_cfm_pcd_bourbon_0324_deltajoint_h16_hist4_extnoise \
