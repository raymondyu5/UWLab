#!/bin/bash
#SBATCH --job-name=uwlab_train_cfm_sim_0317
...
#SBATCH --output=logs/train_cfm_sim_0317_%j.out
#SBATCH --error=logs/train_cfm_sim_0317_%j.err
...
/gscratch/weirdlab/raymond/commands/uwlab/run_in_container.sh '
  ./uwlab.sh -p scripts/imitation_learning/cfm_pcd/train_cfm_pcd.py \
    ...
    training.wandb_run_name=cfm_pcd_sim_0317 \
    hydra.run.dir=/workspace/uwlab/logs/bc_cfm_pcd_sim_0317
'
