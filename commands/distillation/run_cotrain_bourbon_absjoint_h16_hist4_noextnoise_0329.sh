...
#SBATCH --output=/mmfs1/gscratch/weirdlab/raymond/logs/cotrain_bourbon_absjoint_h16_hist4_noextnoise_0329_%j.out
#SBATCH --error=/mmfs1/gscratch/weirdlab/raymond/logs/cotrain_bourbon_absjoint_h16_hist4_noextnoise_0329_%j.err

# Cotrain distill (sim, pour_bottle_0327) + real (03_24_bourbon_pour). No extrinsic noise.
...
/mmfs1/gscratch/weirdlab/raymond/commands/uwlab/run_in_container.sh '
  ./uwlab.sh -p scripts/imitation_learning/cfm_pcd/train_cfm_pcd.py \
    ...
    training.wandb_run_name=cotrain_bourbon_0329_absjoint_h16_hist4_noextnoise \
    hydra.run.dir=/workspace/uwlab/logs/cotrain_bourbon_0329_absjoint_h16_hist4_noextnoise
'
