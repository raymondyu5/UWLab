...
#SBATCH --output=/mmfs1/gscratch/weirdlab/raymond/logs/train_cfm_absjoint_h16_hist4_noextnoise_0325_%j.out
#SBATCH --error=/mmfs1/gscratch/weirdlab/raymond/logs/train_cfm_absjoint_h16_hist4_noextnoise_0325_%j.err
...
/mmfs1/gscratch/weirdlab/raymond/commands/uwlab/run_in_container.sh '
  ./uwlab.sh -p scripts/imitation_learning/cfm_pcd/train_cfm_pcd.py \
    ...
    training.wandb_run_name=cfm_pcd_bourbon_0325_absjoint_h16_hist4_noextnoise \
    hydra.run.dir=/workspace/uwlab/logs/bc_cfm_pcd_bourbon_0325_absjoint_h16_hist4_noextnoise
'
