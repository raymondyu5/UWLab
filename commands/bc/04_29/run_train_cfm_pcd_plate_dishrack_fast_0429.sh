...
#SBATCH --mem=128G
#SBATCH --time=4:00:00
#SBATCH --output=/mmfs1/gscratch/weirdlab/raymond/logs/train_cfm_plate_dishrack_fast_0429_%j.out
#SBATCH --error=/mmfs1/gscratch/weirdlab/raymond/logs/train_cfm_plate_dishrack_fast_0429_%j.err
...
/mmfs1/gscratch/weirdlab/raymond/commands/uwlab/run_in_container.sh '
  ./uwlab.sh -p scripts/imitation_learning/cfm_pcd/train_cfm_pcd.py \
    ...
    training.wandb_run_name=cfm_pcd_plate_dishrack_0429_absjoint_h16_hist4_fast \
    hydra.run.dir=/workspace/uwlab/logs/bc_cfm_pcd_plate_dishrack_0429_absjoint_h16_hist4_fast
'
