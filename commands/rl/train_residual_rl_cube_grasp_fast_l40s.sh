#!/bin/bash
#SBATCH --job-name=uwlab_residual_rl_cube_grasp_a40
...
#SBATCH --output=logs/uwlab_residual_rl_cube_grasp_a40_%j.out
#SBATCH --error=logs/uwlab_residual_rl_cube_grasp_a40_%j.err
...
apptainer exec --nv \
  ...
  --bind /gscratch/weirdlab/raymond/reset_poses_cube_grasp_bourbon_ep1_04_08.json:/workspace/uwlab/assets/reset_poses_cube_grasp.json \
  ...
  /bin/bash -c '
    ...
    ./uwlab.sh -p \
      ...
      --num_envs 4096 \
      --diffusion_path logs/bc_cfm_pcd_cube_grasp_normal_only_0412_absjoint_h16_hist4_noextnoise_fast \
      --cfg configs/rl/arm_residual_only_cfg.yaml \
