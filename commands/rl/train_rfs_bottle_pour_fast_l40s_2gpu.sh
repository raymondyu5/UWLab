#!/bin/bash
#SBATCH --job-name=uwlab_rfs_pour_fast_l40s_2gpu
...
#SBATCH --output=logs/uwlab_rfs_pour_fast_l40s_2gpu_%j.out
#SBATCH --error=logs/uwlab_rfs_pour_fast_l40s_2gpu_%j.err
