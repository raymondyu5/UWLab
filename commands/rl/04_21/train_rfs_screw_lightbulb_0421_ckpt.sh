#!/bin/bash
#SBATCH --job-name=uwlab_rfs_screw_lightbulb_0421
...
#SBATCH --output=logs/uwlab_rfs_screw_lightbulb_0421_%j.out
#SBATCH --error=logs/uwlab_rfs_screw_lightbulb_0421_%j.err
