#!/bin/bash
#SBATCH --job-name=uwlab_rfs_screw_0424_curriculum
...
#SBATCH --output=/mmfs1/gscratch/weirdlab/raymond/logs/rfs_screw_0424_curriculum_%j.out
#SBATCH --error=/mmfs1/gscratch/weirdlab/raymond/logs/rfs_screw_0424_curriculum_%j.err
...
apptainer exec --nv \
  ...
  /bin/bash -c '
    ...
    ./uwlab.sh -p scripts/reinforcement_learning/sb3/rfs/train.py \
      --task UW-FrankaLeap-ScrewLightbulb-Curriculum-JointAbs-v0 \
      --num_envs 4096 \
