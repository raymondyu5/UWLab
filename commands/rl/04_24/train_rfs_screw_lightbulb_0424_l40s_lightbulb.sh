#!/bin/bash
#SBATCH --job-name=uwlab_rfs_screw_0424_light
...
#SBATCH --output=/mmfs1/gscratch/weirdlab/raymond/logs/rfs_screw_0424_light_%j.out
#SBATCH --error=/mmfs1/gscratch/weirdlab/raymond/logs/rfs_screw_0424_light_%j.err
...
apptainer exec --nv \
  ...
  /bin/bash -c '
    ...
    ./uwlab.sh -p scripts/reinforcement_learning/sb3/rfs/train.py \
      --task UW-FrankaLeap-ScrewLightbulb-LightBulb-JointAbs-v0 \
      --num_envs 4096 \
