#!/bin/bash
#SBATCH --job-name=uwlab_rfs_screw_0424_4096
...
#SBATCH --output=/mmfs1/gscratch/weirdlab/raymond/logs/rfs_screw_0424_4096_%j.out
#SBATCH --error=/mmfs1/gscratch/weirdlab/raymond/logs/rfs_screw_0424_4096_%j.err
