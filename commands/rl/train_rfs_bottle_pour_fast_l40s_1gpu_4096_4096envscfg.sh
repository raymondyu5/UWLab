#!/bin/bash
#SBATCH --job-name=uwlab_rfs_pour_fast_l40s_1gpu
...
#SBATCH --output=logs/uwlab_rfs_pour_fast_l40s_1gpu_4096_4096envscfg_%j.out
#SBATCH --error=logs/uwlab_rfs_pour_fast_l40s_1gpu_4096_4096envscfg_%j.err
...
apptainer exec --nv \
  ...
  /bin/bash -c '
    ...
    ./uwlab.sh -p scripts/reinforcement_learning/sb3/rfs/train.py \
      ...
      --num_envs 4096 \
      --diffusion_path logs/bc_cfm_pcd_bottle_pour_mixed_0410_absjoint_h16_hist4_noextnoise_fast \
      --cfg configs/rl/arm_rfs_joint_cfg_4096envs.yaml \
