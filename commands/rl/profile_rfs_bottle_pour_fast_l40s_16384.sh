#!/bin/bash
#SBATCH --job-name=uwlab_rfs_profile_l40s_16384
...
#SBATCH --output=logs/uwlab_rfs_profile_l40s_16384_%j.out
#SBATCH --error=logs/uwlab_rfs_profile_l40s_16384_%j.err
