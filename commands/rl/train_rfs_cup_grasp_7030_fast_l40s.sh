#!/bin/bash
#SBATCH --job-name=uwlab_rfs_cup_grasp_7030_l40s_2gpu
...
#SBATCH --output=logs/uwlab_rfs_cup_grasp_7030_l40s_2gpu_%j.out
#SBATCH --error=logs/uwlab_rfs_cup_grasp_7030_l40s_2gpu_%j.err
...
apptainer exec --nv \
  ...
  /bin/bash -c '
    ...
    ./uwlab.sh -p -m torch.distributed.run \
      ...
      --task UW-FrankaLeap-GraspPinkCupRandomResets7030-JointAbs-v0 \
      --num_envs 4096 \
