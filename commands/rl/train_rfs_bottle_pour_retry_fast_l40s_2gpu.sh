#!/bin/bash
#SBATCH --job-name=uwlab_rfs_pour_retry_l40s_2gpu
...
#SBATCH --output=logs/uwlab_rfs_pour_retry_fast_l40s_2gpu_%j.out
#SBATCH --error=logs/uwlab_rfs_pour_retry_fast_l40s_2gpu_%j.err
...
apptainer exec --nv \
  ...
  /bin/bash -c '
    ...
    ./uwlab.sh -p -m torch.distributed.run \
      ...
      --num_envs 4096 \
      --diffusion_path logs/bc_cfm_pcd_bottle_pour_mixed_0412_absjoint_h16_hist4_noextnoise_fast \
