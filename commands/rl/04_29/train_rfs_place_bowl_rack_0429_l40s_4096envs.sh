#!/bin/bash
#SBATCH --job-name=uwlab_rfs_place_bowl_rack_0429
...
#SBATCH --output=/mmfs1/gscratch/weirdlab/raymond/logs/rfs_place_bowl_rack_0429_%j.out
#SBATCH --error=/mmfs1/gscratch/weirdlab/raymond/logs/rfs_place_bowl_rack_0429_%j.err
