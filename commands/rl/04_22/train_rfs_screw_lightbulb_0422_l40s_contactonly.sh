#!/bin/bash
#SBATCH --job-name=uwlab_rfs_screw_0422_co
...
#SBATCH --output=/mmfs1/gscratch/weirdlab/raymond/logs/rfs_screw_0422_contactonly_%j.out
#SBATCH --error=/mmfs1/gscratch/weirdlab/raymond/logs/rfs_screw_0422_contactonly_%j.err
