#!/bin/bash
#SBATCH --job-name=uwlab_rfs_screw_0422_rotonly
...
#SBATCH --output=/mmfs1/gscratch/weirdlab/raymond/logs/rfs_screw_0422_rotonly_%j.out
#SBATCH --error=/mmfs1/gscratch/weirdlab/raymond/logs/rfs_screw_0422_rotonly_%j.err
