#!/bin/bash
#SBATCH --job-name=uwlab_rfs_screw_0422_contact
...
#SBATCH --output=/mmfs1/gscratch/weirdlab/raymond/logs/rfs_screw_0422_contact_%j.out
#SBATCH --error=/mmfs1/gscratch/weirdlab/raymond/logs/rfs_screw_0422_contact_%j.err
