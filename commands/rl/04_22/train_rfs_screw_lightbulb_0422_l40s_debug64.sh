#!/bin/bash
#SBATCH --job-name=uwlab_rfs_screw_debug64
...
#SBATCH --mem=32G
#SBATCH --time=2:00:00
#SBATCH --output=/mmfs1/gscratch/weirdlab/raymond/logs/rfs_screw_debug64_%j.out
#SBATCH --error=/mmfs1/gscratch/weirdlab/raymond/logs/rfs_screw_debug64_%j.err
