#!/bin/bash
#SBATCH --job-name=uwlab_rfs_bottle_grasp_fast_l40s_0412
...
#SBATCH --output=logs/uwlab_rfs_bottle_grasp_fast_l40s_0412_%j.out
#SBATCH --error=logs/uwlab_rfs_bottle_grasp_fast_l40s_0412_%j.err
...
apptainer exec --nv \
  ...
  /bin/bash -c '
    ...
    ./uwlab.sh -p scripts/reinforcement_learning/sb3/rfs/train.py \
      ...
      --num_envs 4096 \
      --diffusion_path logs/bc_cfm_pcd_bottle_grasp_mixed_0412_absjoint_h16_hist4_noextnoise_fast \
