#!/bin/bash
#SBATCH --job-name=rl_rfs_absjoint_h16_rs16
...
#SBATCH --output=logs/rl_rfs_absjoint_h16_rs16_%j.out
#SBATCH --error=logs/rl_rfs_absjoint_h16_rs16_%j.err
...
apptainer exec --nv \
  ...
  /bin/bash -c '
    ...
    ./uwlab.sh -p scripts/reinforcement_learning/sb3/rfs/train.py \
      ...
      --cfg configs/rl/rfs_cfg_absjoint_h16_rs16.yaml \
