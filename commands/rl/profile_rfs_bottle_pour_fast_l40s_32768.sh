#!/bin/bash
#SBATCH --job-name=uwlab_rfs_profile_l40s_32768
...
#SBATCH --output=logs/uwlab_rfs_profile_l40s_32768_%j.out
#SBATCH --error=logs/uwlab_rfs_profile_l40s_32768_%j.err
