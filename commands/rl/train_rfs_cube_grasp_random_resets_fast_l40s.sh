#!/bin/bash
#SBATCH --job-name=uwlab_rfs_cube_grasp_normal_l40_2gpu
...
#SBATCH --output=logs/uwlab_rfs_cube_grasp_normal_l40_2gpu_%j.out
#SBATCH --error=logs/uwlab_rfs_cube_grasp_normal_l40_2gpu_%j.err
