#!/bin/bash
#SBATCH --job-name=uwlab_dsrl_cube_grasp_a40
...
#SBATCH --output=logs/uwlab_dsrl_cube_grasp_a40_%j.out
#SBATCH --error=logs/uwlab_dsrl_cube_grasp_a40_%j.err
...
apptainer exec --nv \
  ...
  /bin/bash -c '
    ...
    ./uwlab.sh -p \
      ...
      --cfg configs/rl/dsrl_joint_cfg.yaml \
