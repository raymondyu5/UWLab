#!/bin/bash
#SBATCH --job-name=uwlab_rfs_cup_grasp_fast_l40s
...
#SBATCH --output=logs/uwlab_rfs_cup_grasp_fast_l40s_%j.out
#SBATCH --error=logs/uwlab_rfs_cup_grasp_fast_l40s_%j.err
...
apptainer exec --nv \
  ...
  /bin/bash -c '
    ...
    ./uwlab.sh -p scripts/reinforcement_learning/sb3/rfs/train.py \
      ...
      --num_envs 4096 \
      --diffusion_path logs/bc_cfm_pcd_cup_grasp_mixed_0410_absjoint_h16_hist4_noextnoise_fast \
