#!/bin/bash
#SBATCH --job-name=uwlab_rfs_bottle_pour_rr_4gpu
...
#SBATCH --output=logs/uwlab_rfs_bottle_pour_rr_4gpu_%j.out
#SBATCH --error=logs/uwlab_rfs_bottle_pour_rr_4gpu_%j.err
