#!/bin/bash
#SBATCH --job-name=uwlab_rfs_place_bowl_rack_0425
...
#SBATCH --output=/mmfs1/gscratch/weirdlab/raymond/logs/rfs_place_bowl_rack_0425_%j.out
#SBATCH --error=/mmfs1/gscratch/weirdlab/raymond/logs/rfs_place_bowl_rack_0425_%j.err
...
apptainer exec --nv \
  ...
  /bin/bash -c '
    ...
    ./uwlab.sh -p scripts/reinforcement_learning/sb3/rfs/train.py \
      ...
      --num_envs 4096 \
      --diffusion_path logs/bc_cfm_pcd_place_bowl_in_rack_0424_absjoint_h16_hist4_fast \
