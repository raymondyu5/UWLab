#!/bin/bash
#SBATCH --job-name=uwlab_rfs_dishrack_plate_combined_extnoise_0501
...
#SBATCH --output=/mmfs1/gscratch/weirdlab/raymond/logs/rfs_dishrack_plate_combined_extnoise_0501_%j.out
#SBATCH --error=/mmfs1/gscratch/weirdlab/raymond/logs/rfs_dishrack_plate_combined_extnoise_0501_%j.err
...
apptainer exec --nv \
  ...
  /bin/bash -c '
    ...
    ./uwlab.sh -p scripts/reinforcement_learning/sb3/rfs/train.py \
      --task UW-FrankaLeap-PlateInDishRack-JointAbs-v0 \
      --num_envs 4096 \
      --diffusion_path logs/bc_cfm_pcd_dishrack_plate_combined_0501_absjoint_h16_hist4_extnoise_fast \
