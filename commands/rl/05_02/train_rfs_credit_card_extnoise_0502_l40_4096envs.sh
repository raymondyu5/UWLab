#!/bin/bash
#SBATCH --job-name=uwlab_rfs_credit_card_extnoise_0502
...
#SBATCH --output=/mmfs1/gscratch/weirdlab/raymond/logs/rfs_credit_card_extnoise_0502_%j.out
#SBATCH --error=/mmfs1/gscratch/weirdlab/raymond/logs/rfs_credit_card_extnoise_0502_%j.err
...
apptainer exec --nv \
  ...
  /bin/bash -c '
    ...
    ./uwlab.sh -p scripts/reinforcement_learning/sb3/rfs/train.py \
      ...
      --num_envs 4096 \
      --diffusion_path logs/bc_cfm_pcd_credit_card_0502_absjoint_h16_hist4_extnoise_fast \
